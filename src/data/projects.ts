...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: 'Espansione Immobiliare',
    service: 'Social Media',
    serviceSlug: 'social-media-management',
    img: '/Images/EspansioneImmobiliare.png',
    tagline: 'Una presenza social costruita mattone dopo mattone.',
    description: "Espansione Immobiliare è un'agenzia immobiliare che si è affidata a noi per costruire e gestire la propria presenza sui social. Il settore immobiliare richiede un approccio specifico: contenuti che trasmettano fiducia, mettano in vetrina gli immobili nel modo giusto e mantengano vivo il rapporto con potenziali acquirenti e venditori. Abbiamo strutturato un piano editoriale mensile su misura, curato la produzione dei contenuti e gestito i canali in modo continuativo.",
    what: [
      'Gestione canali Instagram e Facebook',
      'Piano editoriale mensile con contenuti immobiliari',
      'Creazione grafiche e post per annunci e immobili in vendita',
      'Reel e video brevi per aumentare la visibilità organica',
      'Gestione messaggi e richieste in arrivo dai social',
      'Report mensile con andamento dei principali indicatori',
    ],
    results: [
      { value: '+180%', label: 'Reach organica in 6 mesi' },
      { value: '×3', label: 'Richieste di valutazione via social' },
      { value: '4.8%', label: 'Tasso di engagement medio' },
    ],
    year: '2024',
  },
  {
